  ...
  return (
    <div className="print-page">
      <style>{`
        ...
        .t6 *{box-sizing:border-box;font-family:'Times New Roman',Times,serif}
        .t6{width:210mm;height:297mm;margin:0 auto;background:#fff;border:3px solid #000;box-shadow:inset 0 0 0 5px #fff,inset 0 0 0 7px #000;padding:3mm 8mm 5mm 8mm;display:flex;flex-direction:column;overflow:hidden}
        .t6 .logo-row{display:flex;align-items:center;justify-content:center;gap:12px;margin-bottom:2mm}
        .t6 .logo-row img{height:60px;width:auto}
        .t6 h1{text-align:center;margin:0;font-size:34px;font-family:'Times New Roman',Times,serif;font-weight:bold;line-height:1.2}
        .t6 .sub{text-align:center;font-size:9.5px;margin:0 0 0.5mm 0;line-height:1.2;letter-spacing:0.3px}
        .t6 .red{border-top:2.5px solid #7a2020;margin:1mm auto 1mm auto;width:100%}
        .t6 .sec{color:#7a2020;font-weight:bold;font-size:13pt;margin:8px 0 3px 0}
        .t6 p{font-size:10.5pt;line-height:1.35;text-align:justify;margin:3px 0}
        .t6 .footer{text-align:center;font-size:10px;line-height:1.5;margin-top:auto}
        .t6 .footer-sep{border-top:2.5px solid #7a2020;margin:0 0 1.5mm 0;width:100%}
      `}</style>
      <div className="t6">
